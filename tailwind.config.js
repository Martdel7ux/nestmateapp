    ...
    theme: {
        ...
        extend: {
            ...
            backgroundImage: {
                ...
                "mesh-dark": "radial-gradient(circle at top left, rgba(34,197,94,0.15), transparent 38%), radial-gradient(circle at top right, rgba(59,130,246,0.2), transparent 32%), linear-gradient(180deg, rgba(2,6,23,0.98), rgba(15,23,42,0.96))"
            },
            keyframes: {
                "fade-up": {
