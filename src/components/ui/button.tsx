  ...
  "inline-flex items-center justify-center gap-2 rounded-full text-sm font-semibold transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        ghost: "bg-transparent px-4 py-2.5 text-foreground hover:bg-muted",
        outline:
          "border border-border bg-card/70 px-5 py-3 text-card-foreground hover:bg-muted/60",
        destructive:
          "bg-destructive px-5 py-3 text-destructive-foreground hover:opacity-90"
      },
      size: {
        default: "h-11",
        sm: "h-9 px-4 text-xs",
